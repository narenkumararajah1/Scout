"""Business Initiative ORM entity (V3 Phase 5 - docs/v3/09_DATA_MODELS.md).

No V2 equivalent - Phase 4A's Knowledge Extraction already produces
ExtractedBusinessInitiative dataclasses (backend/ai/knowledge_extraction.py)
but deliberately never persists them (Stage 4A's "independent of
